...
const c1=new Customer( {firstname:"anabia",lastname:"asma"},15,"female",32872735280284,a1);
c1.display()
c1.bankaccount.debit(500)
console.log()

const a2=new Bankaccount(500)
const c2=new Customer( {firstname:"ana",lastname:"bia"},20,"male",33756302874032,a2);
c2.display()
